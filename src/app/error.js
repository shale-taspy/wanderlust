    ...
    <div className="min-h-[75vh] bg-white text-slate-900 flex flex-col justify-center items-center px-6 py-12 font-sans">
      <div className="text-center max-w-xl mx-auto space-y-6">
        ...
        <p className="text-slate-600 text-sm sm:text-base leading-relaxed max-w-md mx-auto">
          An unexpected server error occurred while processing your request. Don't worry, your itinerary is safe.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center pt-2">
          <button
            onClick={() => reset()}
            className="w-full sm:w-auto px-7 py-3.5 rounded-full bg-[#00A8CC] hover:bg-cyan-600 text-white font-medium text-sm transition-all duration-200 shadow-sm active:scale-[0.98] cursor-pointer"
          >
            Try Again
          </button>
